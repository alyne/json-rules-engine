...
import { EngineFast } from '../../src/index'
import AlmanacFast from '../../src/optimized/almanac-fast'
import sinon from 'sinon'

describe('EngineFast: run', () => {
  ...
  describe('returns', () => {
    ...
    it('includes the almanac', () => {
      return engine.run({ age: 10 }).then(results => {
        expect(results.almanac).to.be.an.instanceOf(AlmanacFast)
  ...
  describe('custom alamanc', () => {
    class CapitalAlmanac extends AlmanacFast {
