...
import { EngineUltra } from '../../src/index'
import AlmanacUltra from '../../src/optimized/almanac-ultra'
import sinon from 'sinon'

describe('EngineUltra: run', () => {
  ...
  describe('returns', () => {
    ...
    it('includes the almanac', () => {
      return engine.run({ age: 10 }).then(results => {
        expect(results.almanac).to.be.an.instanceOf(AlmanacUltra)
  ...
  describe('custom alamanc', () => {
    class CapitalAlmanac extends AlmanacUltra {
